...
import mockup from "../assets/img/game/MockUpOnePiece-min.png";
              ...
              <div className="border-t md:border-t-0 md:border-l p-6 border-secondary flex flex-col justify-between">
                ...
                <div className="mt-4 sm:mt-8">
                  ...
                  <p className="text-[0.8rem] lg:text-[1rem] leading-relaxed">
                    Il s'agit de mon tout premier projet : un jeu de combat
                    rétro en 1v1 inspiré de l'univers de One Piece. Ce fut une
                    expérience passionnante à réaliser durant ma formation de
                    développeuse, et je suis toujours ravie de le présenter.
                    C'était un véritable plaisir de lui donner vie tout en
                    apprenant à le concevoir.
                  </p>
                </div>
              </div>
            </div>

...
const Collaboration = () => {
  return (
    <section className="w-[90%] mx-auto py-16 text-secondary font-sporting-regular">
      ...
      <div className="text-center mb-16">
        ...
        <ZoomText delay={0.3}>
          <p className="text-[0.5rem] sm:text-[0.5rem] lg:text-[0.8rem] xl:text-[1.5rem] 2xl:text-[1rem]">
            Construisez ensemble des projets techniques <br /> avec une vision
            partagée.
          </p>
        </ZoomText>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center gap-24 mb-16">
        {/* Pack Partenariat */}
        <div className="relative" style={{ width: "380px", height: "200px" }}>
          <ZoomText delay={0.3}>
            <div
            ...
            >
              ...
              <p
                ...
                className="mb-4 text-[0.5rem] sm:text-[0.5rem] lg:text-[0.8rem] xl:text-[0.8rem] 2xl:text-[1rem]"
              >
